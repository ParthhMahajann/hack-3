...
async def _seed_demo_data():
    ...
    async with AsyncSessionLocal() as db:
        ...
        patients_data = [
            ...
            # Additional maternal cases for richer demo
            dict(id=str(uuid.uuid4()), patient_type="maternal", asha_id=asha_id,
                 name="Anita Das", age=32, address="101, Rampur", phone="9871234563",
                 lmp="2024-08-10", edd="2025-05-17", gravida=3, para=2,
                 current_risk_level="red", current_risk_score=72),
            dict(id=str(uuid.uuid4()), patient_type="maternal", asha_id=asha_id,
                 name="Kavita Sharma", age=20, address="156, Rampur", phone="9871234564",
                 lmp="2024-10-25", edd="2025-07-31", gravida=1, para=0,
                 current_risk_level="yellow", current_risk_score=40),
            dict(id=str(uuid.uuid4()), patient_type="maternal", asha_id=asha_id,
                 name="Neha Verma", age=26, address="203, Rampur", phone="9871234565",
                 lmp="2024-11-15", edd="2025-08-22", gravida=2, para=1,
                 current_risk_level="green", current_risk_score=15),
            # Additional child cases
            dict(id=str(uuid.uuid4()), patient_type="child", asha_id=asha_id,
                 name="Vikram (M/18mo)", sex="M", birth_date="2023-10-15",
                 address="89, Rampur", current_risk_level="yellow", current_risk_score=38),
            dict(id=str(uuid.uuid4()), patient_type="child", asha_id=asha_id,
                 name="Anaya (F/6mo)", sex="F", birth_date="2024-10-29",
                 address="142, Rampur", current_risk_level="green", current_risk_score=8),
        ]
        ...
        visits_data = [
            ...
            dict(id=str(uuid.uuid4()), patient_id=patient_ids[4], asha_id=asha_id,
                 ...
                 synced_at=now, updated_at=now),
            # Additional visits for enriched demo
            dict(id=str(uuid.uuid4()), patient_id=patient_ids[2], asha_id=asha_id,
                 visit_type="anc", visit_date="2025-04-25",
                 vitals={"hemoglobin": 10.5, "systolic_bp": 135, "diastolic_bp": 88,
                         "weight_kg": 62.5},
                 observations={"edema_generalised": False},
                 risk_level="yellow", risk_score=30,
                 risk_triggered=["Mild anaemia: Hb=10.5 g/dL"],
                 gps_lat=25.3182, gps_lng=82.9741,
                 synced_at=now, updated_at=now),
            dict(id=str(uuid.uuid4()), patient_id=patient_ids[3], asha_id=asha_id,
                 visit_type="anc", visit_date="2025-04-24",
                 vitals={"hemoglobin": 11.8, "systolic_bp": 120, "diastolic_bp": 80,
                         "weight_kg": 58.0},
                 observations={},
                 risk_level="green", risk_score=8,
                 risk_triggered=[],
                 gps_lat=25.3175, gps_lng=82.9738,
                 synced_at=now, updated_at=now),
            dict(id=str(uuid.uuid4()), patient_id=patient_ids[6], asha_id=asha_id,
                 visit_type="anc", visit_date="2025-04-22",
                 vitals={"hemoglobin": 8.1, "systolic_bp": 140, "diastolic_bp": 90},
                 observations={"proteinuria_2plus": True},
                 risk_level="red", risk_score=72,
                 risk_triggered=["Moderate anaemia: Hb=8.1 g/dL", "Pre-eclampsia range BP",
                                 "Proteinuria ≥2+"],
                 gps_lat=25.3190, gps_lng=82.9750,
                 synced_at=now, updated_at=now),
            dict(id=str(uuid.uuid4()), patient_id=patient_ids[5], asha_id=asha_id,
                 visit_type="home_visit", visit_date="2025-04-23",
                 vitals={"muac_mm": 118, "weight_kg": 7.5},
                 observations={"fever_days": 3, "breastfeeding_ok": True},
                 risk_level="yellow", risk_score=38,
                 risk_triggered=["MAM: MUAC=118mm (115-125mm)", "Fever for 3 days"],
                 gps_lat=25.3185, gps_lng=82.9744,
                 synced_at=now, updated_at=now),
            dict(id=str(uuid.uuid4()), patient_id=patient_ids[7], asha_id=asha_id,
                 visit_type="anc", visit_date="2025-04-20",
                 vitals={"hemoglobin": 11.2, "systolic_bp": 118, "diastolic_bp": 78,
                         "weight_kg": 60.0},
                 observations={},
                 risk_level="green", risk_score=12,
                 risk_triggered=[],
                 gps_lat=25.3170, gps_lng=82.9736,
                 synced_at=now, updated_at=now),
            dict(id=str(uuid.uuid4()), patient_id=patient_ids[8], asha_id=asha_id,
                 visit_type="home_visit", visit_date="2025-04-21",
                 vitals={"muac_mm": 125, "weight_kg": 8.2},
                 observations={"fever_days": 0, "breastfeeding_ok": True},
                 risk_level="green", risk_score=5,
                 risk_triggered=[],
                 gps_lat=25.3188, gps_lng=82.9748,
                 synced_at=now, updated_at=now),
            dict(id=str(uuid.uuid4()), patient_id=patient_ids[9], asha_id=asha_id,
                 visit_type="home_visit", visit_date="2025-04-19",
                 vitals={"muac_mm": 120, "weight_kg": 9.0},
                 observations={"fever_days": 0, "breastfeeding_ok": True},
                 risk_level="yellow", risk_score=35,
                 risk_triggered=["Mild underweight: WAZ=-1.5"],
                 gps_lat=25.3172, gps_lng=82.9742,
                 synced_at=now, updated_at=now),
        ]
        ...
        db.add(RiskAlert(
            patient_id=patient_ids[6], risk_level="red", risk_score=72,
            triggered_params=["Moderate anaemia", "Pre-eclampsia range BP", "Proteinuria ≥2+"],
            channels_used=["in_app"]
        ))
